...
This package connects <code>Twitter-Language-Visualizer</code> to <code>rtweet</code>. As a 
...
Expect that the browser will open and ask you to authenticate the app. Press 
the button to accept and authenticate rtweet.
